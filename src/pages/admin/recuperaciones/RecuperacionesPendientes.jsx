...
import {
  ...
  AlertCircle, Shield, Mail, Phone, RefreshCw, BellRing, Key
} from 'lucide-react';
...
const RecuperacionesPendientes = () => {
  ...
  <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-2 sm:p-2.5 md:p-3 rounded-lg sm:rounded-xl shadow-lg shadow-emerald-200">
              ...
              {solicitudes.map((sol) => (
                <div key={sol.id} className="p-6 hover:bg-gray-50 transition-colors">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${sol.estado === 'pendiente' ? 'bg-yellow-100 text-yellow-700' :
